...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Dodaj użytkownika</h1>
            <p class="text-slate-600">Wprowadź dane, aby dodać nowego pracownika do rejestru.</p>
        </div>
    ...
    <div class="bg-white border border-slate-100 rounded-xl shadow-sm p-8 max-w-3xl mx-auto">
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="space-y-1">
                    <label for="password_confirmation" class="block text-sm font-semibold text-slate-700">Potwierdź hasło</label>
            ...
            <div class="space-y-1">
                <label for="photo" class="block text-sm font-semibold text-slate-700">Zdjęcie profilowe</label>
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-200 border-dashed rounded-xl hover:border-emerald-400 transition-colors group">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-slate-500">PNG, JPG, GIF do 2MB</p>
                    </div>
                </div>
